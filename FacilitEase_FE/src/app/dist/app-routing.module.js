...
var routes = [
    ...
    { path: 'l2report/2', component: l2_report_component_1.L2ReportComponent },
    ...
    { path: 'manager-view-employee-tickets', component: manager_view_employee_tickets_component_1.ManagerViewEmployeeTicketsComponent },
    { path: 'manager-view-waiting-tickets', component: manager_view_waiting_tickets_component_1.ManagerViewWaitingTicketsComponent },
    { path: 'manager-view-ticket-detail/:Id', component: manager_view_ticket_detail_component_1.ManagerViewTicketDetailComponent },
